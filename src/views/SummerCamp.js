...
const SummerCamp = () => (
  <MainContainer title="PROGRAMS">
    ...
    <p className="center-margin-top">Grades 2-5 - Coed - June 1,2,3 from 9-11am</p>
    <p className="center-margin-top">Grades 6-8 - Boys - June 1,2,3 from 11:30-1:30pm</p>
    <p className="center-margin-top">Grades 6-8 - Girls - June 7,8,9 from 12-2pm</p>
