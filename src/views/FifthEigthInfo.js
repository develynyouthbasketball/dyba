...
const FifthEightInfo = () => (
	<MainContainer title="LEAGUE INFO">
		...
		<ul>
			...
			<li>Practices: Teams that play in both leagues may have up to 3 practices per week. The 'Gold' and 'Silver' teams for 6th, 7th and 8th grades practice at D'Evelyn.</li>
