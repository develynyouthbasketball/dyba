...
const Home = () => (
	<MainContainer title="WELCOME">
		...
		<p>Our team placement is free to attend and our annual membership dues are $50. These funds are used to cover the costs of running the club (insurance, administrative costs, website hosting, etc). You must be a member of the club to play on our teams.</p>
