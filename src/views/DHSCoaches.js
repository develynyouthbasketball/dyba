...
const DHSCoaches = () => (
	<MainContainer title="STAFF and COACHES">
		...
		<br />
		<div className="row">
			<p>Preston Slaughter - DYBA Director</p>
		...
		<div className="row">
			...
			<div className="dhs-coaches col-xs-12 col-sm-9">
				<p>Coach Zinn joined the D'Evelyn Jaguars in June 2015 as the Boys Varsity Head Coach and Head of Program. Over the past 20 years, he has coached basketball in a variety of roles at the high school and college levels.  One of the reasons Coach Zinn chose to work at schools like D’Evelyn, is the belief in academics as a priority.  He is a believer that the players in this program are student-athletes and he believes in and understands the importance of academics at a school like D'Evelyn. Over the course of his time as the head coach of the Jaguars, the team has an overall record of 57-43, has reached the CHSAA 4A State Playoffs every year, has three "Sweet 16" appearances and one "Great 8" appearance.</p>
			</div>
		</div>
		<br />
		<br />
